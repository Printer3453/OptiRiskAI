...
public class OptiRiskAIEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private void ConfigureInMemorySqlite(IServiceCollection services)
    {
        ...
        _database.CreateTables(
            new OptiRiskAIDbContext(new DbContextOptionsBuilder<OptiRiskAIDbContext>().UseSqlite(_database.ConnectionString).Options));
