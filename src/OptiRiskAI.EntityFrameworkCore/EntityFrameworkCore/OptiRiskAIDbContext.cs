...
public class OptiRiskAIDbContext :
    AbpDbContext<OptiRiskAIDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public OptiRiskAIDbContext(DbContextOptions<OptiRiskAIDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(OptiRiskAIConsts.DbTablePrefix + "Authors",
                OptiRiskAIConsts.DbSchema);
        ...
        {
            b.ToTable(OptiRiskAIConsts.DbTablePrefix + "Books",
                OptiRiskAIConsts.DbSchema);
            b.ConfigureByConvention(); //auto configure for the base class props
        ...
        //{
        //    b.ToTable(OptiRiskAIConsts.DbTablePrefix + "YourEntities", OptiRiskAIConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});
    }
