...
{
    [DbContext(typeof(OptiRiskAIDbContext))]
    [Migration("20260831232052_Added_RiskIntelligence_Entities")]
    partial class Added_RiskIntelligence_Entities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OptiRiskAI.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("OptiRiskAI.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("OptiRiskAI.RiskIntelligence.RiskRule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("AppRiskRules", (string)null);
                });

            modelBuilder.Entity("OptiRiskAI.RiskIntelligence.RiskTelemetry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");

                    b.Property<Guid?>("AppliedRiskRuleId")
                        .HasColumnType("TEXT");

                    b.Property<decimal?>("CalculatedRiskMultiplier")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<double>("DistanceToPowerLineMeters")
                        .HasColumnType("REAL");
                    ...
                    b.Property<double>("SlopePercentage")
                        .HasColumnType("REAL");
                    ...
                    b.ToTable("AppRiskTelemetries", (string)null);
                });
            ...
            modelBuilder.Entity("OptiRiskAI.Books.Book", b =>
                {
                    b.HasOne("OptiRiskAI.Authors.Author", null)
                        .WithMany()
