...
namespace OptiRiskAI.Migrations
{
    /// <inheritdoc />
    public partial class Added_RiskIntelligence_Entities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortBio = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    ExtraProperties = table.Column<string>(type: "TEXT", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatorId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RiskMultiplier = table.Column<decimal>(type: "TEXT", nullable: false),
                    AiRationale = table.Column<string>(type: "TEXT", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    ExtraProperties = table.Column<string>(type: "TEXT", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppRiskRules", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AppRiskTelemetries",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Latitude = table.Column<double>(type: "REAL", nullable: false),
                    Longitude = table.Column<double>(type: "REAL", nullable: false),
                    DistanceToPowerLineMeters = table.Column<double>(type: "REAL", nullable: false),
                    WindSpeedKmh = table.Column<double>(type: "REAL", nullable: false),
                    SlopePercentage = table.Column<double>(type: "REAL", nullable: false),
                    VegetationType = table.Column<string>(type: "TEXT", nullable: false),
                    AppliedRiskRuleId = table.Column<Guid>(type: "TEXT", nullable: true),
                    CalculatedRiskMultiplier = table.Column<decimal>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppRiskTelemetries", x => x.Id);
                });
