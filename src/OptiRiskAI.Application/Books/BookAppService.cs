...
namespace OptiRiskAI.Books;

[Authorize(OptiRiskAIPermissions.Books.Default)]
public class BookAppService : ApplicationService, IBookAppService
{
    ...
    [Authorize(OptiRiskAIPermissions.Books.Create)]
    ...
    [Authorize(OptiRiskAIPermissions.Books.Edit)]
    ...
    [Authorize(OptiRiskAIPermissions.Books.Delete)]
