...
public class OptiRiskAIDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        OptiRiskAIGlobalFeatureConfigurator.Configure();
        OptiRiskAIModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<OptiRiskAIDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<OptiRiskAIResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/OptiRiskAI");

            options.DefaultResourceType = typeof(OptiRiskAIResource);
        ...
        {
            options.MapCodeNamespace("OptiRiskAI", typeof(OptiRiskAIResource));
        });
    }
}
